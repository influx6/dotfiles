...
# install oh-my-bash directory if it does not exists
if [[ ! -d "$HOME/.oh-my-bash" ]]; then
	# installation: bash -c "$(curl -fsSL https://raw.githubusercontent.com/ohmybash/oh-my-bash/master/tools/install.sh)"
...
export DOTFILES=$HOME/Labs/ewestudios/dotfiles
